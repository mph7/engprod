...
const InstagramCard = ({ post }) => {
  return (
    <div className="instagram-card">
      <a href={post.post.postLink} target="_blank">
        <div className="instagram-card-top">
          <div className="account-image">
            <img src={post.account.accountImage} alt="instagram account image "/>
          </div>
          <span className="account-name">{post.account.accountName}</span>
        </div>
        ...
        <div className="instagram-card-bottom">
          ...
          <div className="comment-button">
            <svg aria-label="Comment" color="rgb(0, 0, 0)" fill="rgb(0, 0, 0)" height="24"
          ...
          <div className="share-button">
            <svg aria-label="Share Post" className="x1lliihq x1n2onr6" color="rgb(0, 0, 0)" fill="rgb(0, 0, 0)"
